# -*- coding: utf-8 -*-
"""
Created on Tue Mar  7 11:25:19 2017
...
W_conv2 = weight_variable([1, 5, 20, 40])
b_conv2 = bias_variable([40])

h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2x2(h_conv2)

W_fc1 = weight_variable([n_x_data * 1*40, 100])
b_fc1 = bias_variable([100])

h_pool2_flat = tf.reshape(h_pool2, [-1, n_x_data*40])
...
#    print(sess.run(y_conv, {x: x_data, y_: y, keep_prob: 1.0}))